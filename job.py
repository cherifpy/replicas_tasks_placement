...
class Replica:
    def __init__(self, job_id, node_id, data_size, transfer_time,transfer_start_time, makespan=0,time_to_start=None):
        self.job_id = job_id
...
class Job:
    ...
    def __init__(self, job_id, tasks_duration, nb_tasks, dataset_size, type_of_job=None):
        self.job_id = job_id
        ...
        self.learned_pool = None  # learned cluster (KMeans), assigned on arrival -- cf. jobs_injector
